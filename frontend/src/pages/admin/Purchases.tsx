    ...
    <Container className="py-6 sm:py-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 mb-6 bg-surface p-4 rounded-radius border border-border/20 items-end">
        <div className="space-y-1">
          <Label htmlFor="start-date" className="text-xs font-semibold">Start Date & Time</Label>
          <Input
            id="start-date"
            type="datetime-local"
            value={startDate}
        ...
        <div className="space-y-1">
          <Label htmlFor="end-date" className="text-xs font-semibold">End Date & Time</Label>
          <Input
            id="end-date"
            type="datetime-local"
            value={endDate}
      ...
      {loading ? (
        ...
        <p className="text-muted-foreground">No orders match the selected date range.</p>
      ) : (
